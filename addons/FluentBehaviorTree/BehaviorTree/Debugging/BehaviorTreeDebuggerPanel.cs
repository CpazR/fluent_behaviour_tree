...
public partial class BehaviorTreeDebuggerPanel : PanelContainer {
    ...
    /**
     * Contains both the <see cref="treeContainer"/> for the behavior tree and the <see cref="blackboardContainer"/> in horizontal order
     */
    private HSplitContainer debugContentContainer = new HSplitContainer();

    /**
     * Behavior tree UI contents
     */
    ...
    private void SelectTree(Dictionary tree) {
        ...
        rootControl = new BehaviorTreeViewContainer(behavior);
    ...
    public void UpdateTree(Dictionary behaviorTree) {
        ...
        UpdateBlackboardTable(behaviorTree["blackboard"].AsGodotDictionary());
    }
